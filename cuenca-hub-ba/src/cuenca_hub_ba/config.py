...
NEO4J_USER = "neo4j"
# La contraseña fue cambiada a jrK8Qd7wf2rggJW
...
HIGH_QUALITY_THRESHOLD = 0.3  # Threshold más permisivo para más fuentes
EXCELLENT_THRESHOLD = 0.7  # Threshold para fuentes excelentes
MIN_SOURCES = 3  # Mínimo para diversidad
MAX_SOURCES = 8  # Máximo controlado
OPTIMAL_SOURCES = 5  # Óptimo para respuestas completas
...
def setup_global_settings():
    ...
    if GEMINI_API_KEY:
        ...
        print("⚠️  GEMINI_API_KEY no configurada. Solo retrieval disponible.")
